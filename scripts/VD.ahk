...
class VD {
    ...
    static _init() {
        ...
        this.IVirtualDesktopManager := ComObject("{aa509086-5ca9-4c25-8f95-589d3c07b48a}",
            "{a5cd92ff-29be-454c-8d04-d82879fb3f1b}")
        this.ptr_MoveWindowToDesktop := this._vtable(this.IVirtualDesktopManager.Ptr, 5)
        this.CImmersiveShell_IServiceProvider := ComObject("{c2f03a33-21f5-47fa-b4bb-156362a2f239}",
            "{6d5140c1-7436-11ce-8034-00aa006009fa}")
        this.IVirtualDesktopManagerInternal := ComObjQuery(this.CImmersiveShell_IServiceProvider.Ptr,
            "{c5e0cdca-7b6e-41b2-9fc4-d93975cc467b}", IID_IVirtualDesktopManagerInternal_str)
        this.IVirtualDesktopPinnedApps := ComObjQuery(this.CImmersiveShell_IServiceProvider.Ptr,
            "{b5a399e7-1c87-46b8-88e9-fc5747b171bd}", "{4ce81583-1e4c-4632-a621-07a53543148f}")
        this.IApplicationViewCollection := ComObjQuery(this.CImmersiveShell_IServiceProvider.Ptr,
            "{1841c6d7-4f9d-42c0-af41-8747538f10e5}", "{1841c6d7-4f9d-42c0-af41-8747538f10e5}")
    ...
    static _dll_MoveViewToDesktop_normal(IApplicationView, IVirtualDesktop) {
        DllCall(this.ptr_MoveViewToDesktop, "Ptr", this.IVirtualDesktopManagerInternal.Ptr, "Ptr", IApplicationView,
            "Ptr", IVirtualDesktop)
    }
    static _dll_GetCurrentDesktop_normal() {
        DllCall(this.ptr_GetCurrentDesktop, "Ptr", this.IVirtualDesktopManagerInternal.Ptr, "Ptr*", &
            IVirtualDesktop_currentDesktop := 0)
    ...
    static _dll_CreateDesktop_normal() {
        DllCall(this.ptr_CreateDesktop, "Ptr", this.IVirtualDesktopManagerInternal.Ptr, "Ptr*", &
            IVirtualDesktop_created := 0)
        return IVirtualDesktop_created
    }
    static _dll_RemoveDesktop_normal(IVirtualDesktop, IVirtualDesktop_fallback) {
        DllCall(this.ptr_RemoveDesktop, "Ptr", this.IVirtualDesktopManagerInternal.Ptr, "Ptr", IVirtualDesktop, "Ptr",
            IVirtualDesktop_fallback)
    }
    static _dll_GetCurrentDesktop_HMONITOR() {
        DllCall(this.ptr_GetCurrentDesktop, "Ptr", this.IVirtualDesktopManagerInternal.Ptr, "Ptr", 0, "Ptr*", &
            IVirtualDesktop_currentDesktop := 0)
        return IVirtualDesktop_currentDesktop
    }
    static _dll_GetDesktops_HMONITOR() {
        DllCall(this.ptr_GetDesktops, "Ptr", this.IVirtualDesktopManagerInternal.Ptr, "Ptr", 0, "Ptr*", &IObjectArray :=
            0)
        return IObjectArray
    }
    static _dll_SwitchDesktop_HMONITOR(IVirtualDesktop) {
        DllCall(this.ptr_SwitchDesktop, "Ptr", this.IVirtualDesktopManagerInternal.Ptr, "Ptr", 0, "Ptr",
            IVirtualDesktop)
    }
    static _dll_CreateDesktop_HMONITOR() {
        DllCall(this.ptr_CreateDesktop, "Ptr", this.IVirtualDesktopManagerInternal.Ptr, "Ptr", 0, "Ptr*", &
            IVirtualDesktop_created := 0)
        return IVirtualDesktop_created
    }
    static _dll_IsAppIdPinned(exe_path) {
        DllCall(this.ptr_IsAppIdPinned, "Ptr", this.IVirtualDesktopPinnedApps.Ptr, "WStr", exe_path, "Int*", &
            appIsPinned := 0)
        return appIsPinned
    }
    ...
    static _dll_IsViewPinned(IApplicationView) {
        DllCall(this.ptr_IsViewPinned, "Ptr", this.IVirtualDesktopPinnedApps.Ptr, "Ptr", IApplicationView, "Int*", &
            viewIsPinned := 0)
        return viewIsPinned
    }
    ...
    static _dll_GetViewForHwnd(HWND) {
        DllCall(this.ptr_GetViewForHwnd, "Ptr", this.IApplicationViewCollection.Ptr, "Ptr", HWND, "Ptr*", &
            IApplicationView := 0)
    ...
    static goToDesktopNum(desktopNum, shouldActivateUponArrival := true) {
        ...
        if (VD.animation_on && firstWindowId) {
            if (this.idx_SwitchDesktopWithAnimation > -1) {
                ...
                DllCall(this.ptr_SwitchDesktopWithAnimation, "Ptr", this.IVirtualDesktopManagerInternal.Ptr, "Ptr",
                    IVirtualDesktop)
                ...
                DllCall(this.ptr_MoveWindowToDesktop, "Ptr", this.IVirtualDesktopManager.Ptr, "Ptr",
                    VD_animation_gui_hwnd, "Ptr", GUID_Desktop)
    ...
    static _onceLocalizedWord_TaskView() {
        hModule := (hModule := DllCall("GetModuleHandle", "Str", "twinui.pcshell.dll", "Ptr")) ? hModule : DllCall(
            "LoadLibrary", "Str", "twinui.pcshell.dll", "Ptr")
    ...
    static getNameFromDesktopNum(desktopNum) {
        ...
        if (desktopNum > 0 && this.idx_GetName > -1) {
            ...
            if (IVirtualDesktop) {
                ...
                desktopName := StrGet(DllCall("combase\WindowsGetStringRawBuffer", "Ptr", HSTRING, "Uint*", &length :=
                    0, "Ptr"), "UTF-16")
    ...
    static setNameToDesktopNum(desktopName, desktopNum) {
        if (desktopNum > 0 && this.idx_SetDesktopName > -1) {
            IVirtualDesktop := this._GetDesktops_Obj().GetAt(desktopNum)
            if (IVirtualDesktop) {
                DllCall("combase\WindowsCreateString", "WStr", desktopName, "Uint", StrLen(desktopName), "Ptr*", &
                HSTRING := 0)
                DllCall(this.ptr_SetDesktopName, "Ptr", this.IVirtualDesktopManagerInternal.Ptr, "Ptr", IVirtualDesktop,
                    "Ptr", HSTRING)
                DllCall("combase\WindowsDeleteString", "Ptr", HSTRING)
            }
        }
    ...
    static getWallpaperFromDesktopNum(desktopNum) {
        ...
        if (desktopNum > 0 && this.idx_GetWallpaper > -1) {
            ...
            if (IVirtualDesktop) {
                ...
                desktopWallpaper := StrGet(DllCall("combase\WindowsGetStringRawBuffer", "Ptr", HSTRING, "Uint*", &
                    length := 0, "Ptr"), "UTF-16")
                DllCall("combase\WindowsDeleteString", "Ptr", HSTRING)
            }
        }
    ...
    static setWallpaperToDesktopNum(desktopWallpaper, desktopNum) {
        if (desktopNum > 0 && this.idx_SetDesktopWallpaper > -1) {
            IVirtualDesktop := this._GetDesktops_Obj().GetAt(desktopNum)
            if (IVirtualDesktop) {
                DllCall("combase\WindowsCreateString", "WStr", desktopWallpaper, "Uint", StrLen(desktopWallpaper),
                "Ptr*", &HSTRING := 0)
                DllCall(this.ptr_SetDesktopWallpaper, "Ptr", this.IVirtualDesktopManagerInternal.Ptr, "Ptr",
                    IVirtualDesktop, "Ptr", HSTRING)
                DllCall("combase\WindowsDeleteString", "Ptr", HSTRING)
            }
        }
    }
    ...
    static _dll_QueryInterface_Same(riid, ppvObject) {
        ...
        if ((NumGet(riid + 0, 0x0, "Int64") == 0 && NumGet(riid + 0, 0x8, "Int64") == 5044031582654955712) || (NumGet(
            riid + 0, 0x0, "Int64") == VD.IID_IVirtualDesktopNotification_n1 && NumGet(riid + 0, 0x8, "Int64") == VD.IID_IVirtualDesktopNotification_n2
        )) {
    ...
    static _dll_VirtualDesktopDestroyBegin_normal(IVirtualDesktop_destroyed, IVirtualDesktop_fallback) {
        VD.VirtualDesktopDestroyBegin.Call(VD._desktopNum_from_IVirtualDesktop(IVirtualDesktop_destroyed), VD._desktopNum_from_IVirtualDesktop(
            IVirtualDesktop_fallback))
        return 0
    }
    static _dll_VirtualDesktopDestroyFailed_normal(IVirtualDesktop_destroyed, IVirtualDesktop_fallback) {
        VD.VirtualDesktopDestroyFailed.Call(VD._desktopNum_from_IVirtualDesktop(IVirtualDesktop_destroyed), VD._desktopNum_from_IVirtualDesktop(
            IVirtualDesktop_fallback))
        return 0
    }
    static _dll_VirtualDesktopDestroyed_normal(IVirtualDesktop_destroyed, IVirtualDesktop_fallback) {
        VD.VirtualDesktopDestroyed.Call(VD._desktopNum_from_IVirtualDesktop(IVirtualDesktop_destroyed), VD._desktopNum_from_IVirtualDesktop(
            IVirtualDesktop_fallback))
        return 0
    }
    ...
    static _dll_CurrentVirtualDesktopChanged_normal(IVirtualDesktop_old, IVirtualDesktop_new) {
        VD.CurrentVirtualDesktopChanged.Call(VD._desktopNum_from_IVirtualDesktop(IVirtualDesktop_old), VD._desktopNum_from_IVirtualDesktop(
            IVirtualDesktop_new))
        return 0
    }
    static _dll_VirtualDesktopNameChanged_normal(IVirtualDesktop, HSTRING) {
        desktopName := StrGet(DllCall("combase\WindowsGetStringRawBuffer", "Ptr", HSTRING, "Uint*", &length := 0, "Ptr"
        ), "UTF-16")
        DllCall("combase\WindowsDeleteString", "Ptr", HSTRING)
    ...
    static _dll_VirtualDesktopDestroyBegin_IObjectArray(IObjectArray, IVirtualDesktop_destroyed,
        IVirtualDesktop_fallback) {
        VD.VirtualDesktopDestroyBegin.Call(VD._desktopNum_from_IVirtualDesktop(IVirtualDesktop_destroyed), VD._desktopNum_from_IVirtualDesktop(
            IVirtualDesktop_fallback))
        return 0
    }
    static _dll_VirtualDesktopDestroyFailed_IObjectArray(IObjectArray, IVirtualDesktop_destroyed,
        IVirtualDesktop_fallback) {
        VD.VirtualDesktopDestroyFailed.Call(VD._desktopNum_from_IVirtualDesktop(IVirtualDesktop_destroyed), VD._desktopNum_from_IVirtualDesktop(
            IVirtualDesktop_fallback))
        return 0
    ...
    static RegisterDesktopNotifications() {
        methods_ptr := DllCall("GlobalAlloc", "Uint", 0x40, "Uint", this.IVirtualDesktopNotification_methods_count *
            A_PtrSize)
        ...
        NumPut("Ptr", CallbackCreate(this._dll_VirtualDesktopCreated, "F"), methods_ptr + this.idx_VirtualDesktopCreated *
        A_PtrSize, "Ptr")
        NumPut("Ptr", CallbackCreate(this._dll_VirtualDesktopDestroyBegin, "F"), methods_ptr + this.idx_VirtualDesktopDestroyBegin *
        A_PtrSize, "Ptr")
        NumPut("Ptr", CallbackCreate(this._dll_VirtualDesktopDestroyFailed, "F"), methods_ptr + this.idx_VirtualDesktopDestroyFailed *
        A_PtrSize, "Ptr")
        NumPut("Ptr", CallbackCreate(this._dll_VirtualDesktopDestroyed, "F"), methods_ptr + this.idx_VirtualDesktopDestroyed *
        A_PtrSize, "Ptr")
        NumPut("Ptr", CallbackCreate(this._dll_ViewVirtualDesktopChanged, "F"), methods_ptr + this.idx_ViewVirtualDesktopChanged *
        A_PtrSize, "Ptr")
        NumPut("Ptr", CallbackCreate(this._dll_CurrentVirtualDesktopChanged, "F"), methods_ptr + this.idx_CurrentVirtualDesktopChanged *
        A_PtrSize, "Ptr")
        if (this.idx_VirtualDesktopNameChanged > -1) {
            NumPut("Ptr", CallbackCreate(this._dll_VirtualDesktopNameChanged, "F"), methods_ptr + this.idx_VirtualDesktopNameChanged *
            A_PtrSize, "Ptr")
        }
        if (this.idx_VirtualDesktopWallpaperChanged > -1) {
            NumPut("Ptr", CallbackCreate(this._dll_VirtualDesktopWallpaperChanged, "F"), methods_ptr + this.idx_VirtualDesktopWallpaperChanged *
            A_PtrSize, "Ptr")
        }
        ptr := methods_ptr
    ...
    static RegisterDesktopNotifications_Same(methods_ptr) {
        ...
        IDesktopNotificationService := ComObjQuery(this.CImmersiveShell_IServiceProvider.Ptr,
            "{A501FDEC-4A09-464C-AE4E-1B9C21B84918}", "{0CD45E71-D927-4F15-8B0A-8FEF525337BF}")
...
breakToReturnFalse:
    ...
    class IObjectArray_Wrapper {
        ...
        GetAt(oneBasedIndex) {
            DllCall(this.ptr_GetAt, "Ptr", this.IObjectArray, "UInt", oneBasedIndex - 1, "Ptr", this.IID_Interface_ptr,
                "Ptr*", &IInterface := 0)
            return IInterface
        }
        GetCount() {
